...
#define ZC_SAPLING_ENCPLAINTEXT_SIZE (ZC_NOTEPLAINTEXT_LEADING + ZC_DIVERSIFIER_SIZE + ZC_V_SIZE + ZC_R_SIZE + ZC_ASSET_TYPE_SIZE + ZC_MEMO_SIZE)
...
#define ASSET_ZCASH 0
#define ASSET_STR4DBUCKS 1337
