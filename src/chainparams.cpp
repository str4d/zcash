...
public:
    CTestNetParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_NU6_1].nActivationHeight = 3520085;
        consensus.vUpgrades[Consensus::UPGRADE_ZFUTURE].nProtocolVersion = 0x7FFFFFFF;
        consensus.vUpgrades[Consensus::UPGRADE_ZFUTURE].nActivationHeight =
            Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        ...
        // Testnet funding streams
        {
            ...
            // ZIP 214 Revision 2
            // FPF uses a single address repeated 28 times, once for each funding period.
            // There are 28 periods because the start height is after the second halving
            // on testnet and does not align with a period boundary.
            std::vector<std::string> fpf_addresses_h3(28, "t2HifwjUj9uyxr9bknR8LFuQbc98c3vkXtu");
            consensus.AddZIP207FundingStream(
                keyConstants,
