...
public:
    ...
    //!   hashLightClientRoot.
    //! - For blocks from Heartwood activation on, this is only set once a block has been
    //!   connected to the main chain, and will be null otherwise.
    uint256 hashFinalSaplingRoot;

    //! Root of the ZIP 221 history tree as of the end of the previous block.
    //! - For blocks prior to Heartwood activation, this is always null.
    //! - For blocks from Heartwood activation on, this is always equal to
    //!   hashLightClientRoot.
